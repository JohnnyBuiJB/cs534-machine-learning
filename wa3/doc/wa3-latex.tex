...
\answer{
In the worst case, every split will split one example from the rest. Hence, the algorithm will result in the full binary tree with the height of $m - 1$ and $2^{m - 1}$ leaf nodes.
}
